    ...
    if uploaded_file and child_age and child_name:
        with st.spinner(f"正在為 {child_name} 產生專屬評估報告..."):
            try:
                ...
                3. 完全代入「現場老師」視角，直接用肯定句描述正在發生的客觀事實。
                ...
                ### 🌱 【智慧鷹架引導】
                #### 💡 引發思考的提問
                請提供 2 個具體的開放式問題，協助老師在現場與孩子互動。
                #### 🎨 具體延伸玩法
                請提供 1 個延伸建議。⚠️ 注意：標題請直接顯示「具體延伸玩法」，後面不要出現「(+1 難度)」等任何括號註記。
